        ...
        builder.setTitle("Choose Subject")
                .setItems(R.array.subjects, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ((EditText)findViewById(R.id.subjectText)).setText(String.valueOf(Subject.fromOrdinal(which)));
                    }
...
*/
    ...
    public void addBookOnClick (View view) throws IOException//get all the info the user entered on the form and sends to func to add book
    {
        ...
        Subject subjects = Subject.valueOf(((EditText)findViewById(R.id.subjectText)).getText().toString());
